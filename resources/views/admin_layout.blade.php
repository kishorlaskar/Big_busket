...
<body >
	...
	<div class="navbar" >
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{URL::to('/dashboard')}}"><span>BiG BuSkEt</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all_catagorey')}}"><i class="icon-envelope"></i><span class="hidden-tablet">All Catagorey</span></a></li>
						<li><a href="{{URL::to('/add_catagorey')}}"><i class="icon-tasks"></i><span class="hidden-tablet"> Add Catagorey</span></a></li>
						<li><a href="{{URL::to('/all_brand')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Brands</span></a></li>
						<li><a href="{{URL::to('/add_brand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Brands</span></a></li>
						<li>
						...
						<li><a href="{{URL::to('/shop_name')}}"><i class="icon-font"></i><span class="hidden-tablet"> Shop Name</span></a></li>
						<li><a href="{{URL::to('/delivery_man')}}"><i class="icon-picture"></i><span class="hidden-tablet">Delivery Man</span></a></li>
	...
	<footer>
		...
		<p>
			...
			<span class="hidden-phone" style="text-align:right;float:right">Powered by: <a href="{{URL::to('/dashboard')}}" alt="Bootstrap Admin Templates">BiG BuSkEt</a></span>
		</p>

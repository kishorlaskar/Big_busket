			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						...
						action="{{url('/update_brand',$brand_info->manufacture_id)}}" method="post">
							{{ csrf_field() }}
						  <fieldset>
							<div class="control-group">
							  <label class="control-label">Manufacture Name</label>
							  <div class="controls">
							<input type="text" class="input-xlarge focused" name="manufacture_name" value="{{$brand_info->manufacture_name}}">
							  </div>
							</div>          
							<div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="3" name="manufacture_description">
									{{$brand_info->manufacture_description}}
								</textarea>
							  </div>
							</div>
